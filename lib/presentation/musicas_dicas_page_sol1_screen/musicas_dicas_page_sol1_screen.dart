...
class MusicasDicasPageSol1Screen
    extends GetWidget<MusicasDicasPageSol1Controller> {
  @override
                ...
                child: Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                              padding: getPadding(left: 18, top: 21, right: 39),
                              child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    CustomImageView(
                          ...
                          Padding(
                              padding: getPadding(left: 1, top: 22, right: 30),
                              child: Row(children: [
                                Expanded(
                                    child: Container(
                                        padding: getPadding(
                                ...
                                CustomIconButton(
                                    height: 49,
                                    width: 47,
                                    margin: getMargin(left: 10, top: 4),
